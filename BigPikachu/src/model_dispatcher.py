...
MODEL_DISPATCHER = {
    ...
    'se_resnext101_32x4d':models.SE_ResNext101_32x4d_sSE(pretrained=True, n_class=3),
    'se_resnext101_32x4d_eval':models.SE_ResNext101_32x4d_sSE(pretrained=False, n_class=3),
